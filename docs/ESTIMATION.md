...
모든 공급사에는 소수점 아래 숫자를 버린 정수 지침을 제출합니다. 예를 들어 128.9 m³는 반올림하지 않고 128 m³로 제출하며, 직접 입력과 자동 제출에 동일하게 적용합니다. 추정과 실측 기록에는 소수값을 보관할 수 있고, 제출 확인 화면에는 실제 전송할 정수가 표시됩니다.
