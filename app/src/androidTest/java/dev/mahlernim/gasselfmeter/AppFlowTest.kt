...
class AppFlowTest {
    ...
    @Test fun onboardingDemoCalibrationPersistenceAndHistory() {
        ...
        ActivityScenario.launch(MainActivity::class.java).use { scenario ->
            ...
            compose.onNodeWithText("한국 시간 기준 · 공급사에서 제출 완료를 확인하면 알림을 멈춰요.").performScrollTo().assertIsDisplayed()
            ...
            compose.onNodeWithText("3회").performScrollTo().assertIsDisplayed()
            shot("05-settings")
            compose.onNodeWithText("3회").performClick()
